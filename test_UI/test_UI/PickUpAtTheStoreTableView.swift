...
import UIKit
class PickUpAtTheStoreTableView: UITableViewCell {
   let fixedHeightCollapsedTableViewLable = UILabel()
    ...
    override func layoutSubviews() {
        ...
        tableView.register(AddressCellTableViewCell.self,forCellReuseIdentifier: "AddressCellTableViewCell")
...
extension PickUpAtTheStoreTableView:UITableViewDataSource ,UITableViewDelegate {
